      ...
      <View style={[styles.card, { width: width, marginBottom: 1 }]}>
        <Animated.View
          style={[
            ...
            { backgroundColor: "rgb(36, 173, 251)" }
          ]}
        />
        <Animated.Text style={[styles.mainHeadingStyle, paymentTextColorStyle]}>
          Payment
        </Animated.Text>
        <Animated.Text style={[paymentTextColorStyle, styles.subHeadingStyle]}>
